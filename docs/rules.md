...
Mercenaries, estates and the war share one rising price: the first three cost 2 each, the next three 3 each, and so on (2, 2, 2, 3, 3, 3, 4…). So three cost 6 in all, six 15, nine 27.
...
- **Building.** Each round a dynasty's estates cost the rising price (2, 2, 2, 3, 3, 3, 4… gold), wherever it builds them. Estates can only be built in imperial provinces.
...
- **Mercenaries** cost the rising price (2, 2, 2, 3, 3, 3, 4… gold), up to 10. They all go to the same place.
...
- **Theodosian Walls:** the Basileus always has 5 support. The Walls also defend Constantinople in war (see The War).
...
- **Invader stronger.** The invader walks its route and pays for each province it takes with the strength it has over the frontier, at the rising price: 2, 2, 2, 3, 3, 3, 4… for the first imperial provinces and so on. Lost provinces cost nothing. It stops at the first province it cannot pay for.
- **Constantinople** ends some routes. It costs the invader the next price plus the Theodosian Walls (5). If the invader can pay for it too, the empire falls and nobody wins.
...
- **Best defender.** When the frontier wins, the dynasty with the most troops there is rewarded for each province the lead could pay for on the route, lost or not, at the rising price in gold and the same in Triumph: 6 gold and 6 Triumph for three provinces, 15 of each for six. Tied dynasties share: gold rounded up, Triumph rounded down.
...
- **Estate** (economy): Land a dynasty owns in a province: pays it 1 gold every income while the province is imperial. A province can hold any number of estates of any dynasties. In the Estates phase each dynasty secretly plans new ones at the rising price (2, 2, 2, 3, 3, 3, 4… gold that round).
...
- **Rising price** (economy): The price shared by estates, mercenaries and the war: 2, 2, 2, 3, 3, 3, 4… The first 3 cost 2 each, and every next 3 cost 1 more.
...
- **Mercenaries** (army): Troops hired with gold in Deployment at the rising price (2, 2, 2, 3, 3, 3, 4…), up to 10. All go to the same place.
...
- **Theodosian Walls** (throne): The walls of Constantinople: 5 support for the Basileus in every coup, and 5 more strength an invader needs to take Constantinople.
...
- **Triumph** (throne): Support for the best defender of the last war, for that dynasty itself, in the next coup only: the rising price for each province won (2, 2, 2, 3, 3, 3, 4…).
...
- **Invasion ladder** (war): How much the invader must beat the frontier by to take each province on its route: each imperial province costs the rising price (2, 2, 2, 3, 3, 3, 4…), added up along the route; lost provinces cost nothing, and Constantinople costs the Theodosian Walls on top. Shown on the invasion card and as "+N" tags on the map.
...
- **Reconquest** (war): When the frontier wins, its lead retakes lost provinces on the route at the rising price, starting from the end nearest Constantinople.
- **Best defender** (war): The dynasty with the most troops at the frontier in a won war. For each province the frontier's lead could pay for on the route, lost or not, it gets the rising price (2, 2, 2, 3, 3, 3, 4…) in gold and the same in Triumph.
