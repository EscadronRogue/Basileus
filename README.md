...
Players are rival noble houses inside the Byzantine Empire. Each round draws an invasion, opens Court where major offices may make up to two appointments or revocations in any mix while the Basileus may make up to four revocations of strategoi or private estates, pays estate and church income, resolves sealed bids for free estates, and resolves simultaneous Deployment. Major titles are redistributed before Court only when a coup has installed a new Basileus. During Deployment, all Strategos troops controlled by one player deploy together as one Strategoi army. Some invasions march on Constantinople, while limited invasions only threaten their configured target route and do not launch if no target province remains under imperial control. After the last played turn, Court resolves and a final income phase runs. Win by earning points for each 10% share of gold reserves, profit income, and combined office income (church plus troop income) from that last income phase while surviving the political fallout. If Constantinople falls, everyone loses; the final standings only record who held the strongest position when the empire collapsed.
