...
const DEFAULT_HYBRID_MODE_COUNT = Object.keys(TRAINING_MODES).length - FEATURE_UNIT;
const DEFAULT_ROUND_MODE_RATE = FEATURE_UNIT / Math.max(FEATURE_UNIT, DEFAULT_HYBRID_MODE_COUNT);
...
const DEFAULT_CHECKPOINT_EVAL_EPISODES = OFFICIAL_MAX_SCORE;
const DEFAULT_CHECKPOINT_EVAL_SEED_COUNT = Math.max(FEATURE_UNIT, SCORE_CATEGORY_KEYS.length - FEATURE_UNIT);
