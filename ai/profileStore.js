...
function normalizeTrainingMetadata(rawTraining = {}) {
  ...
  return {
    ...
    averageProjectionError: roundTo(clamp(safeNumber(rawTraining.averageProjectionError, 0), 0, 1), 4),
    averageDecisionQuality: roundTo(clamp(safeNumber(rawTraining.averageDecisionQuality, 0), 0, 1), 4),
    ...
    behaviorProfile: {
      ...
      averageDefenderRewards: roundTo(Math.max(0, safeNumber(behaviorProfile.averageDefenderRewards, 0)), 4),
      defenderGoldChoiceRate: roundTo(clamp(safeNumber(behaviorProfile.defenderGoldChoiceRate, 0), 0, 1), 4),
      averageDefenderRewardGold: roundTo(Math.max(0, safeNumber(behaviorProfile.averageDefenderRewardGold, 0)), 4),
      averageThroneCaptures: roundTo(Math.max(0, safeNumber(behaviorProfile.averageThroneCaptures, 0)), 4),
      averageTitleShuffles: roundTo(Math.max(0, safeNumber(behaviorProfile.averageTitleShuffles, 0)), 4),
      supporterTitleRewardRate: roundTo(clamp(safeNumber(behaviorProfile.supporterTitleRewardRate, 0), 0, 1), 4),
      rivalOfficeDenialRate: roundTo(clamp(safeNumber(behaviorProfile.rivalOfficeDenialRate, 0), 0, 1), 4),
      ...
      averageCoordinatedClaimantDeals: roundTo(Math.max(0, safeNumber(behaviorProfile.averageCoordinatedClaimantDeals, 0)), 4),
      averageFrontierCoordinationDeals: roundTo(Math.max(0, safeNumber(behaviorProfile.averageFrontierCoordinationDeals, 0)), 4),
      averageSystemicDecisions: roundTo(Math.max(0, safeNumber(behaviorProfile.averageSystemicDecisions, 0)), 4),
      averageProjectedUtility: roundTo(safeNumber(behaviorProfile.averageProjectedUtility, 0), 4),
      averageProjectedRisk: roundTo(Math.max(0, safeNumber(behaviorProfile.averageProjectedRisk, 0)), 4),
      averageProjectedFlexibility: roundTo(safeNumber(behaviorProfile.averageProjectedFlexibility, 0), 4),
      averageProjectionError: roundTo(clamp(safeNumber(behaviorProfile.averageProjectionError, rawTraining.averageProjectionError ?? 0), 0, 1), 4),
      averageDecisionQuality: roundTo(clamp(safeNumber(behaviorProfile.averageDecisionQuality, rawTraining.averageDecisionQuality ?? 0), 0, 1), 4),
    },
