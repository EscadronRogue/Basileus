...
test('opening phase starts title redistribution before the first court', () => {
  const state = makeState();
...
test('final phase redistributes titles before final court even when the throne did not change', () => {
  const state = makeState();
